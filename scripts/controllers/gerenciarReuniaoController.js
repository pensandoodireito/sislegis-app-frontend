angular.module('sislegisapp').controller(
		...
		function($scope, $rootScope, $http, $filter, $routeParams, $location, $modal, $log, $timeout, toaster,
				...
				UsuarioResource, ElaboracaoNormativaResource, BACKEND) {
			...
			$scope.abrirModalEncaminhamentos = function(item) {
				...
				modalInstance.result.then(function(selectedProposicao) {
					...
					// o certo era receber a lista como parametro, mas no
					// dismiss nao consegui passar parametro,
					// entao carrego a lista de novo para atualizar a qtde
					$scope.selectedProposicao.listaEncaminhamentoProposicao = EncaminhamentoProposicaoResource
							.findByProposicao({
...
angular.module('sislegisapp').controller(
		...
		function($scope, $http, $filter, $routeParams, $location, toaster, $modalInstance, proposicao,
			...
			$scope.removerProposicao = function() {
				...
				ReuniaoProposicaoResource.remove({
					ReuniaoId : $scope.proposicao.idReuniao,
