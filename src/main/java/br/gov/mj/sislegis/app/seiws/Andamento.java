...
public class Andamento  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.seiws.Usuario usuario;
    ...
    public Andamento(
           ...
           br.gov.mj.sislegis.app.seiws.Usuario usuario) {
     ...
     * @return usuario
     */
    public br.gov.mj.sislegis.app.seiws.Usuario getUsuario() {
        return usuario;
    }
     ...
     * @param usuario
     */
    public void setUsuario(br.gov.mj.sislegis.app.seiws.Usuario usuario) {
        this.usuario = usuario;
    }
