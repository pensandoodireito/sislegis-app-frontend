...
public class Publicacao  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.seiws.PublicacaoImprensaNacional imprensaNacional;
    ...
    public Publicacao(
           ...
           br.gov.mj.sislegis.app.seiws.PublicacaoImprensaNacional imprensaNacional) {
     ...
     */
    public br.gov.mj.sislegis.app.seiws.PublicacaoImprensaNacional getImprensaNacional() {
        return imprensaNacional;
    }
     ...
     */
    public void setImprensaNacional(br.gov.mj.sislegis.app.seiws.PublicacaoImprensaNacional imprensaNacional) {
        this.imprensaNacional = imprensaNacional;
    }
