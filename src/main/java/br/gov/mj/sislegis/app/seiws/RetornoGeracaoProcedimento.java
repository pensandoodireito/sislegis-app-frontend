...
public class RetornoGeracaoProcedimento  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.seiws.RetornoInclusaoDocumento[] retornoInclusaoDocumentos;
    ...
    public RetornoGeracaoProcedimento(
           ...
           br.gov.mj.sislegis.app.seiws.RetornoInclusaoDocumento[] retornoInclusaoDocumentos) {
     ...
     */
    public br.gov.mj.sislegis.app.seiws.RetornoInclusaoDocumento[] getRetornoInclusaoDocumentos() {
        return retornoInclusaoDocumentos;
    }
     ...
     */
    public void setRetornoInclusaoDocumentos(br.gov.mj.sislegis.app.seiws.RetornoInclusaoDocumento[] retornoInclusaoDocumentos) {
        this.retornoInclusaoDocumentos = retornoInclusaoDocumentos;
    }
