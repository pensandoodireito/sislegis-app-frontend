...
public class UnidadeProcedimentoAberto  implements java.io.Serializable {
    private br.gov.mj.sislegis.app.seiws.Unidade unidade;

    private br.gov.mj.sislegis.app.seiws.Usuario usuarioAtribuicao;

    public UnidadeProcedimentoAberto() {
    }

    public UnidadeProcedimentoAberto(
           br.gov.mj.sislegis.app.seiws.Unidade unidade,
           br.gov.mj.sislegis.app.seiws.Usuario usuarioAtribuicao) {
     ...
     * @return unidade
     */
    public br.gov.mj.sislegis.app.seiws.Unidade getUnidade() {
        return unidade;
    }
     ...
     * @param unidade
     */
    public void setUnidade(br.gov.mj.sislegis.app.seiws.Unidade unidade) {
        this.unidade = unidade;
    }
     ...
     */
    public br.gov.mj.sislegis.app.seiws.Usuario getUsuarioAtribuicao() {
        return usuarioAtribuicao;
    }
     ...
     */
    public void setUsuarioAtribuicao(br.gov.mj.sislegis.app.seiws.Usuario usuarioAtribuicao) {
        this.usuarioAtribuicao = usuarioAtribuicao;
    }
