...
public class Documento  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.ws.Remetente remetente;

    private br.gov.mj.sislegis.app.ws.Interessado[] interessados;

    private br.gov.mj.sislegis.app.ws.Destinatario[] destinatarios;
    ...
    public Documento(
           ...
           br.gov.mj.sislegis.app.ws.Remetente remetente,
           br.gov.mj.sislegis.app.ws.Interessado[] interessados,
           br.gov.mj.sislegis.app.ws.Destinatario[] destinatarios,
     ...
     * @return remetente
     */
    public br.gov.mj.sislegis.app.ws.Remetente getRemetente() {
        return remetente;
    }
     ...
     * @param remetente
     */
    public void setRemetente(br.gov.mj.sislegis.app.ws.Remetente remetente) {
        this.remetente = remetente;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.Destinatario[] getDestinatarios() {
        return destinatarios;
    }
     ...
     * @param destinatarios
     */
    public void setDestinatarios(br.gov.mj.sislegis.app.ws.Destinatario[] destinatarios) {
        this.destinatarios = destinatarios;
    }
