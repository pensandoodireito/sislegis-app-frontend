...
public class RetornoConsultaDocumento  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.ws.Serie serie;

    private java.lang.String numero;

    private java.lang.String data;

    private br.gov.mj.sislegis.app.ws.Unidade unidadeElaboradora;

    private br.gov.mj.sislegis.app.ws.Andamento andamentoGeracao;

    private br.gov.mj.sislegis.app.ws.Assinatura[] assinaturas;

    private br.gov.mj.sislegis.app.ws.Publicacao publicacao;
    ...
    public RetornoConsultaDocumento(
           ...
           br.gov.mj.sislegis.app.ws.Serie serie,
           java.lang.String numero,
           java.lang.String data,
           br.gov.mj.sislegis.app.ws.Unidade unidadeElaboradora,
           br.gov.mj.sislegis.app.ws.Andamento andamentoGeracao,
           br.gov.mj.sislegis.app.ws.Assinatura[] assinaturas,
           br.gov.mj.sislegis.app.ws.Publicacao publicacao) {
     ...
     * @return serie
     */
    public br.gov.mj.sislegis.app.ws.Serie getSerie() {
        return serie;
    }
     ...
     * @param serie
     */
    public void setSerie(br.gov.mj.sislegis.app.ws.Serie serie) {
        this.serie = serie;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.Unidade getUnidadeElaboradora() {
        return unidadeElaboradora;
    }
     ...
     */
    public void setUnidadeElaboradora(br.gov.mj.sislegis.app.ws.Unidade unidadeElaboradora) {
        this.unidadeElaboradora = unidadeElaboradora;
    }
     ...
     * @return assinaturas
     */
    public br.gov.mj.sislegis.app.ws.Assinatura[] getAssinaturas() {
        return assinaturas;
    }
     ...
     * @param assinaturas
     */
    public void setAssinaturas(br.gov.mj.sislegis.app.ws.Assinatura[] assinaturas) {
        this.assinaturas = assinaturas;
    }
     ...
     * @return publicacao
     */
    public br.gov.mj.sislegis.app.ws.Publicacao getPublicacao() {
        return publicacao;
    }
     ...
     * @param publicacao
     */
    public void setPublicacao(br.gov.mj.sislegis.app.ws.Publicacao publicacao) {
        this.publicacao = publicacao;
    }
