...
public class RetornoConsultaProcedimento  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.ws.TipoProcedimento tipoProcedimento;

    private br.gov.mj.sislegis.app.ws.Andamento andamentoGeracao;

    private br.gov.mj.sislegis.app.ws.Andamento andamentoConclusao;

    private br.gov.mj.sislegis.app.ws.Andamento ultimoAndamento;

    private br.gov.mj.sislegis.app.ws.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto;

    private br.gov.mj.sislegis.app.ws.Assunto[] assuntos;

    private br.gov.mj.sislegis.app.ws.Interessado[] interessados;

    private br.gov.mj.sislegis.app.ws.Observacao[] observacoes;

    private br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] procedimentosRelacionados;

    private br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] procedimentosAnexados;
    ...
    public RetornoConsultaProcedimento(
           ...
           br.gov.mj.sislegis.app.ws.TipoProcedimento tipoProcedimento,
           br.gov.mj.sislegis.app.ws.Andamento andamentoGeracao,
           br.gov.mj.sislegis.app.ws.Andamento andamentoConclusao,
           br.gov.mj.sislegis.app.ws.Andamento ultimoAndamento,
           br.gov.mj.sislegis.app.ws.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto,
           br.gov.mj.sislegis.app.ws.Assunto[] assuntos,
           br.gov.mj.sislegis.app.ws.Interessado[] interessados,
           br.gov.mj.sislegis.app.ws.Observacao[] observacoes,
           br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] procedimentosRelacionados,
           br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] procedimentosAnexados) {
     ...
     */
    public br.gov.mj.sislegis.app.ws.TipoProcedimento getTipoProcedimento() {
        return tipoProcedimento;
    }
     ...
     */
    public void setTipoProcedimento(br.gov.mj.sislegis.app.ws.TipoProcedimento tipoProcedimento) {
        this.tipoProcedimento = tipoProcedimento;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.Andamento getAndamentoGeracao() {
        return andamentoGeracao;
    }
     ...
     */
    public void setAndamentoGeracao(br.gov.mj.sislegis.app.ws.Andamento andamentoGeracao) {
        this.andamentoGeracao = andamentoGeracao;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.Andamento getAndamentoConclusao() {
        return andamentoConclusao;
    }
     ...
     */
    public void setAndamentoConclusao(br.gov.mj.sislegis.app.ws.Andamento andamentoConclusao) {
        this.andamentoConclusao = andamentoConclusao;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.Andamento getUltimoAndamento() {
        return ultimoAndamento;
    }
     ...
     */
    public void setUltimoAndamento(br.gov.mj.sislegis.app.ws.Andamento ultimoAndamento) {
        this.ultimoAndamento = ultimoAndamento;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.UnidadeProcedimentoAberto[] getUnidadesProcedimentoAberto() {
        return unidadesProcedimentoAberto;
    }
     ...
     */
    public void setUnidadesProcedimentoAberto(br.gov.mj.sislegis.app.ws.UnidadeProcedimentoAberto[] unidadesProcedimentoAberto) {
        this.unidadesProcedimentoAberto = unidadesProcedimentoAberto;
    }
     ...
     * @return observacoes
     */
    public br.gov.mj.sislegis.app.ws.Observacao[] getObservacoes() {
        return observacoes;
    }
     ...
     * @param observacoes
     */
    public void setObservacoes(br.gov.mj.sislegis.app.ws.Observacao[] observacoes) {
        this.observacoes = observacoes;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] getProcedimentosRelacionados() {
        return procedimentosRelacionados;
    }
     ...
     */
    public void setProcedimentosRelacionados(br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] procedimentosRelacionados) {
        this.procedimentosRelacionados = procedimentosRelacionados;
    }
     ...
     */
    public br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] getProcedimentosAnexados() {
        return procedimentosAnexados;
    }
     ...
     */
    public void setProcedimentosAnexados(br.gov.mj.sislegis.app.ws.ProcedimentoResumido[] procedimentosAnexados) {
        this.procedimentosAnexados = procedimentosAnexados;
    }
