...
public class RetornoGeracaoProcedimento  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.ws.RetornoInclusaoDocumento[] retornoInclusaoDocumentos;
    ...
    public RetornoGeracaoProcedimento(
           ...
           br.gov.mj.sislegis.app.ws.RetornoInclusaoDocumento[] retornoInclusaoDocumentos) {
     ...
     */
    public br.gov.mj.sislegis.app.ws.RetornoInclusaoDocumento[] getRetornoInclusaoDocumentos() {
        return retornoInclusaoDocumentos;
    }
     ...
     */
    public void setRetornoInclusaoDocumentos(br.gov.mj.sislegis.app.ws.RetornoInclusaoDocumento[] retornoInclusaoDocumentos) {
        this.retornoInclusaoDocumentos = retornoInclusaoDocumentos;
    }
