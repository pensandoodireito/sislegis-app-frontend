...
public class SeiServiceLocator extends org.apache.axis.client.Service implements br.gov.mj.sislegis.app.ws.SeiService {
    ...
    public br.gov.mj.sislegis.app.ws.SeiPortType getSeiPortService() throws javax.xml.rpc.ServiceException {
    ...
    public br.gov.mj.sislegis.app.ws.SeiPortType getSeiPortService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.gov.mj.sislegis.app.ws.SeiBindingStub _stub = new br.gov.mj.sislegis.app.ws.SeiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.gov.mj.sislegis.app.ws.SeiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.gov.mj.sislegis.app.ws.SeiBindingStub _stub = new br.gov.mj.sislegis.app.ws.SeiBindingStub(new java.net.URL(SeiPortService_address), this);
                _stub.setPortName(getSeiPortServiceWSDDServiceName());
                return _stub;
            }
        }
