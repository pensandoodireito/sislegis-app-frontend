...
public class UnidadeProcedimentoAberto  implements java.io.Serializable {
    ...
    private br.gov.mj.sislegis.app.ws.Usuario usuarioAtribuicao;
    ...
    public UnidadeProcedimentoAberto(
           ...
           br.gov.mj.sislegis.app.ws.Usuario usuarioAtribuicao) {
     ...
     */
    public br.gov.mj.sislegis.app.ws.Usuario getUsuarioAtribuicao() {
        return usuarioAtribuicao;
    }
     ...
     */
    public void setUsuarioAtribuicao(br.gov.mj.sislegis.app.ws.Usuario usuarioAtribuicao) {
        this.usuarioAtribuicao = usuarioAtribuicao;
    }
