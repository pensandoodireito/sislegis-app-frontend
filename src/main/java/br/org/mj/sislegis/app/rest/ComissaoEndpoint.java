...
public class ComissaoEndpoint
{
   ...
   @GET
   @Produces("application/json")
   public List<Comissao> listAll(@QueryParam("start") Integer startPosition, @QueryParam("max") Integer maxResult)throws Exception
   {

      return comissaoService.listarComissoesCamara(startPosition, maxResult);
   }
