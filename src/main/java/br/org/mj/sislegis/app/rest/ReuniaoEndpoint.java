...
public class ReuniaoEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Reuniao> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT r FROM Reuniao r LEFT JOIN FETCH r.listaProposicao WHERE r.id = :entityId ORDER BY r.id",
						Reuniao.class);
	...
	public List<ProposicaoJSON> findByData(@QueryParam("data") String data) {
		...
		List<ProposicaoJSON> lista = proposicaoService
				.buscarProposicoesPorDataReuniao(date);
