...
insert into Proposicao (id, ano, autor, dataApresentacao, ementa, idProposicao, numero, tipo, origem) values (2, '2014', 'Parlamentar 2', CURRENT_DATE, 'Dispõe sobre o armazenamento de botijões de gás liquefeito de petróleo-GLP e dá outras providências.', 20918, '4491', 'PL', 'C');
insert into Proposicao (id, ano, autor, dataApresentacao, ementa, idProposicao, numero, tipo, origem) values (3, '2014', 'Parlamentar 3', CURRENT_DATE, 'Criminaliza condutas praticadas contra cães e gatos, e dá outras providências.', 529820, '2833', 'PL', 'C');
